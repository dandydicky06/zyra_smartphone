...
const productsData = [
  {
    img: "./Assets/Images/zyraabout.png",
    prices: "$1279,17",
    category: "New Products",
    title: "ZYRA ION RXZ10",
  ...
  },
  {
    ...
    prices: "$471,30",
    category: "Popular Products",
    title: "ZYRA XS Series",
    description: "First releases of ZYRA Smartphones with enough specifications and cheap prices",
...
const articleData = [
  {
    ...
    title: "Pre-Order of ZYRA Fold4 5G and Flip4 5G",
    description: "Along with the announcement of the ZYRA Fold4 5G and ZYRA Flip4 5G, We also announced prices and availability for the ZYRA Fold4 5G device in Indonesia.",
  },
  {
    img: "Assets/Images/article-2.jpg",
    uploadedAt: new Date("September 06, 2022 08:24:00"),
    title: "4 ZYRA Smartphones Recommendations",
    description: "This year our company has developed many smartphones but if you are confused this article will help you find the best ZYRA smartphone so far",
  },
  {
    img: "Assets/Images/article-3.jpg",
    uploadedAt: new Date("September 03, 2022 15:21:00"),
    title: "ZYRA PRO 11 Review: Battery 6000mAh, Storage 128GB",
    description: "The new smartphone ZYRA Pro 11 was recently released and has entered the market in many countries this time we will review the results of our company's smartphone...",
  },
  {
    img: "Assets/Images/article-4.jpg",
    uploadedAt: new Date("August 28, 2022 09:18:00"),
    title: "7 ZYRA smartphones features you need to knows",
    description: "To make it easier for users and to be able to use the potential of the ZYRA smartphone well, we will provide some suggestions regarding the features...",
  },
  {
    img: "Assets/Images/article-5.jpg",
    uploadedAt: new Date("August 23, 2022 22:54:00"),
    title: "How to boosts game performance on ZYRA smartphone",
    description: "Some ZYRA smartphones have been given advanced system features to make the user's gaming performance smoother and more comfortable",
  },
  {
    img: "Assets/Images/article-6.jpg",
    uploadedAt: new Date("August 19, 2022 18:44:00"),
    title: "Tips to make the ZYRA Smartphone more durable",
    description: "Some of the following tips can make you users of ZYRA smartphones can be more durable and not easily damaged",
  },
];
